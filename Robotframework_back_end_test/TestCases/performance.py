...
def run_performance_test(endpoint, id=1):
    """This function performance test of the API.
    It takes the endpoint and id as parameters.
    The default id is 1.
    The function returns the results of performance test into the file results_of_performance.txt
    """
    start_time = time.time()
    response_times = []
    # the time of performance test has been increased to 10 seconds to do not overload the RAM
    while time.time() - start_time < 30:
        ...
        print('Tic-Tock')
    with open("results_of_performance.txt", "w") as file:
    ...
    return "results were saved into results_of_performance.txt"
